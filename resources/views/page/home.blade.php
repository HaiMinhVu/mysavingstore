		...
		<div class="main-content">
			...
			<div class="row">
				<div class="col-sm-12">
								...
								<div class="single-item">
									...
									<div class="single-item-body">
										...
										@if($row_news->promotion_price == 0)
											<p class="single-item-price"><span>${{$row_news->unit_price}}</span>
											</p>
										@endif
										@if($row_news->promotion_price > 0)
											<p class="single-item-price">
												<span class="flash-del">${{$row_news->unit_price}}</span>
												<span class="flash-sale">${{$row_news->promotion_price}}</span>
											</p>
										@endif
									</div>
									<!-- <div class="single-item-caption">
										<a class="add-to-cart pull-left" href="addcart/{{$row_news->id}}"><i class="fa fa-shopping-cart"></i></a>
										<a class="beta-btn primary" href="product/{{$row_news->id}}">View<i class="fa fa-chevron-right"></i></a>
										<div class="clearfix"></div>
									</div> -->
								</div>
							</div>
					...
					<div class="beta-products-list">
						<h4><strong>Promotion Product</strong></h4>
						<div class="beta-products-details">
							<div class="clearfix"></div>
						</div>
						<div class="row">
							...
							<div class="col-sm-3">
								<div class="single-item">
									...
									<div class="single-item-body">
										...
										<p class="single-item-price">
											<span class="flash-del">${{$row_top->unit_price}}</span>
											<span class="flash-sale">${{$row_top->promotion_price}}</span>
										</p>
									</div>
									<!-- <div class="single-item-caption">
