...
class PageController extends Controller
{
	...
	public function __construct()
	{
		...
		$menu = ProductType::where('active', 1)->get();
		view()->share('menu',$menu);
	}

    public function home()
    {
    	$newproduct = Product::where('new',1)->where('active', 1)->inRandomOrder()->limit(8)->get();
    	$topproduct = Product::where('promotion_price','>',0)->where('active', 1)->inRandomOrder()->limit(8)->get();
    ...
    {
    	$product = Product::where('active', 1)->find($id);
        if($product){
        	$same_pro = Product::where('id_type',$product->id_type)->where('active', 1)->take(3)->get();
        	$new_pro = Product::where('new',1)->where('active', 1)->take(5)->get();
        	$best_seller = Product::where('promotion_price','>',0)->where('active', 1)->take(5)->get();
